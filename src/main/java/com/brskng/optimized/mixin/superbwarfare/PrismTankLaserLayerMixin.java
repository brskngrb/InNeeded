...
@Pseudo @Mixin(targets="com.atsuishio.superbwarfare.client.layer.vehicle.PrismTankLaserLayer", remap=false)
public abstract class PrismTankLaserLayerMixin {
    ...
    private void skip(PoseStack ps, @Coerce Object anim, @Coerce Object model, RenderType rt, MultiBufferSource bs, VertexConsumer vc, float tick, int light, int overlay, CallbackInfo ci){
        ...
        double d = BrskngsOptimizedClientConfig.SUPERB_WARFARE_PRISM_LASER_RENDER_DISTANCE.get();
